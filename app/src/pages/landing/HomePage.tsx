...
const features = [
  {
    ...
    description:
      "All users undergo KYC verification. Your funds are protected with bank-level security.",
  },
  {
    icon: TrendingUp,
    title: "Competitive Returns",
    description:
      "Earn up to 18% annual returns as a lender. Better than traditional savings accounts.",
  },
  {
    icon: Users,
    title: "Peer-to-Peer",
    description:
      "Direct connection between borrowers and lenders. No middleman, lower costs.",
  },
  {
    icon: Wallet,
    title: "Easy Payments",
    description:
      "Seamless deposit and withdrawal via VNPay. Track all transactions in real-time.",
  },
];
...
const testimonials = [
  {
    ...
    role: "Business Owner",
    content:
      "Nexo helped me expand my coffee shop when banks rejected my loan. The process was fast and transparent.",
    rating: 5,
  },
  {
    name: "Trần Thu Hà",
    role: "Lender",
    content:
      "I've been investing on Nexo for 6 months. Returns are consistent and the platform is very user-friendly.",
    rating: 5,
  },
  {
    name: "Lê Hoàng Đức",
    ...
    content:
      "Got funding for my tech startup in just 2 weeks. The community of lenders is amazing.",
    rating: 5,
  },
];
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mb-8">
                Nexo connects borrowers who need funding with investors seeking
                better returns. Start your journey to financial freedom today.
              </p>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-muted-foreground">
              Whether you're starting a business or funding education, we've got
              you covered.
            </p>
          </div>
            ...
            {loanPurposes.map((purpose, index) => (
              <Card key={index} className="text-center card-hover">
                <CardContent className="pt-6">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Interest from {purpose.rate}/year
                  </p>
                </CardContent>
              </Card>
            ))}
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              ...
              },
              {
                ...
                desc: "Become a borrower or lender (or both!)",
              },
              {
                step: "03",
                title: "Start Transacting",
                desc: "Request loans or invest in opportunities",
              },
            ].map((item, index) => (
          ...
          <Card className="bg-gradient-to-br from-primary/20 to-primary/5 border-primary/20">
            <CardContent className="py-12 text-center">
              ...
              <p className="text-muted-foreground max-w-xl mx-auto mb-8">
                Join Nexo today and experience the future of peer-to-peer
                lending. Whether you need funds or want to invest, we're here to
                help.
              </p>
