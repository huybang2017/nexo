...
export default function LoansManagementPage() {
  ...
  const pendingCount =
    statusFilter === "PENDING_REVIEW" || statusFilter === "all"
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-white">
                  {formatCurrency(
                    loans.reduce(
                      (sum: number, l: any) => sum + (l.requestedAmount || 0),
                      0
                    ),
                    true
                  )}
            ...
            {isLoading ? (
              ...
              <Table>
                ...
                <TableBody>
                  {loans.map((loan: any) => {
                    const status =
                      statusConfig[loan.status] || statusConfig.PENDING_REVIEW;
                    return (
                      <TableRow
                        key={loan.id}
...
const LoanRowActions: React.FC<{ loan: any }> = ({ loan }) => {
  return (
    <DropdownMenu>
